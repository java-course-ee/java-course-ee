...
START TRANSACTION;
USE `bank`;
INSERT INTO `bank`.`person` (`id`, `first_name`, `last_name`, `birth_date`)
VALUES (NULL, 'Ivan', 'Ivanov', '1985-01-01');
INSERT INTO `bank`.`person` (`id`, `first_name`, `last_name`, `birth_date`)
VALUES (NULL, 'Petr', 'Petrov', '1980-02-03');
INSERT INTO `bank`.`person` (`id`, `first_name`, `last_name`, `birth_date`)
VALUES (NULL, 'Sidor', 'Sidorov', '1993-04-12');
...
START TRANSACTION;
USE `bank`;
INSERT INTO `bank`.`transfer` (`id`, `senders_account`, `recievers_account`, `amount`, ` COMMENT `)
VALUES (NULL, 1, 4, 100, 'Долг за пиво');
INSERT INTO `bank`.`transfer` (`id`, `senders_account`, `recievers_account`, `amount`, ` COMMENT `)
VALUES (NULL, 6, 3, 29000.01, 'Оплата квартиры за вычетом коммунальных платежей');
