...
<html>
    ...
    <body>
		...
		<table border="1" bordercolor="#000000" style="background-color: whitesmoke;" width="500" cellpadding="1" cellspacing="0">
			<thead>
				<tr>
			...
			<tbody
				...
				<c:if test="${fn:length(fromAccount.incommingTransfers) == 0}">
					<tr><td colspan="3" align="center" style="color:red;">Транзакций нет</td></tr>
				</c:if>
			</tbody>
		</table>

		<table style="margin-top: 50px;background-color: whitesmoke;" border="1" bordercolor="#000000" width="500" cellpadding="1" cellspacing="0">
			<thead>
				<tr>
