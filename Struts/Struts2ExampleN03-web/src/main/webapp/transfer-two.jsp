...
<html>
    ...
    <body>
		<p>Шаг 2:</p>
		<p>Перевод срадств от <s:property value="person.firstName"/> <s:property value="person.lastName"/> к <s:property value="toPerson.firstName"/> <s:property value="toPerson.lastName"/>:</p>
