...
(function ($) { // hide the namespace
    ...
    $.extend(datetimepicker.prototype, {
        ...
        _doKeyDown: function (event) {
            ...
            if ($.datetimepicker._datetimepickerShowing)
                switch (event.keyCode) {
                    ...
                    case 13:
                        var sel = $('td.' + $.datetimepicker._dayOverClass +
                    ...
                    case 35:
                        if (event.ctrlKey || event.metaKey) $.datetimepicker._clearDate(event.target);
                        handled = event.ctrlKey || event.metaKey;
                        break; // clear on ctrl or command +end
                    case 36:
                        if (event.ctrlKey || event.metaKey) $.datetimepicker._gotoToday(event.target);
                        handled = event.ctrlKey || event.metaKey;
                        break; // current on ctrl or command +home
                    case 37:
                        if (event.ctrlKey || event.metaKey) $.datetimepicker._adjustDate(event.target, (isRTL ? +1 : -1), 'D');
                        handled = event.ctrlKey || event.metaKey;
                        ...
                        break;
                    case 38:
                        if (event.ctrlKey || event.metaKey) $.datetimepicker._adjustDate(event.target, -7, 'D');
                        handled = event.ctrlKey || event.metaKey;
        ...
        _checkExternalClick: function (event) {
            ...
            if (($target.parents('#' + $.datetimepicker._mainDivId).length == 0) && !$target.hasClass($.datetimepicker.markerClassName) && !$target.hasClass($.datetimepicker._triggerClass) &&
        ...
        _selectI: function (id) {
            ...
            /*if (s<10){ s='0'+s; }*/
            $(id).text(s);
            this._selectDate(this.seldateid, this.seldatestr);
        },
        ...
        _formatTime: function (inst, dhh, dii, dss) {
            if ((dhh == '') || (dii == '') || (dss == '')) {
                return false
            }
